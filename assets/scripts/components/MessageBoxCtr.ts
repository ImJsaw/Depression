...
export default class MessageBoxCtr extends cc.Component {
    ...
    @property(cc.Sprite) private backGroundLeft: cc.Sprite = null;
    @property(cc.Sprite) private backGroundRight: cc.Sprite = null;

    @property(cc.Sprite) private titleText: cc.Sprite = null;

    @property(cc.Sprite) private titleBackGroundLeft: cc.Sprite = null;
    @property(cc.Sprite) private titleBackGroundRight: cc.Sprite = null;

    /**內容文字Label */
    @property(cc.Label) contentText: cc.Label = null;

    @property(cc.Button) private oneCheckBtn: cc.Button = null;

    @property(cc.Button) private twoCheckBtnLeft: cc.Button = null;

    @property(cc.Button) private twoCheckBtnRight: cc.Button = null;

    private contentColor: cc.Color = cc.Color.BLACK;

    private contentSize: number = 40;

    onLoad() {
        this.backGroundLeft.spriteFrame = null;
        this.backGroundRight.spriteFrame = null;
        this.titleText.spriteFrame = null;
        this.titleBackGroundLeft.spriteFrame = null;
        this.titleBackGroundRight.spriteFrame = null;
    ...
    showMsgContent(_background: cc.SpriteFrame, _titletext: cc.SpriteFrame, _titlebackground: cc.SpriteFrame, _contenttext: string) {
        this.backGroundLeft.spriteFrame = _background;
        this.backGroundRight.spriteFrame = _background;
        this.titleText.spriteFrame = _titletext;
        this.titleBackGroundLeft.spriteFrame = _titlebackground;
        this.titleBackGroundRight.spriteFrame = _titlebackground;
